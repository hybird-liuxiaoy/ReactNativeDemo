...
public class RNPushService extends Service {
    ...
    public void onCreate() {
        Log.d(TAG, "onCreate");
        super.onCreate();
        RNWebsocketPushHelper.getInstance(getApplicationContext()).startForeground(this);
        mServiceThread = new Thread() {
            @Override
            public void run() {
                RNWebsocketPushHelper.getInstance(getApplicationContext()).startWebSocket();
            }
        };
    ...
    public void onDestroy() {
        ...
        RNWebsocketPushHelper.getInstance(getApplicationContext()).stopForeground(this);
        RNWebsocketPushHelper.getInstance(getApplicationContext()).stopWebSocket();
        super.onDestroy();
    }
