...
public class RNNotificationAndroid extends ReactContextBaseJavaModule {
    ...
    public void clearNotification() {
        ...
        RNNotificationAndroidHelper.getInstance().clearNotification(getReactApplicationContext());
    }

    @ReactMethod
    public void getApplicationIconBadgeNumber(Callback c) {
        Log.d(TAG,"getApplicationIconBadgeNumber");
        int num = RNNotificationAndroidHelper.getInstance().getApplicationIconBadgeNumber(getReactApplicationContext());
        if (num>-1){
            c.invoke(null,num);
        }
    }
    ...
    public void showNotification(String message) {
        ...
        RNNotificationAndroidHelper.getInstance().showNotification(getReactApplicationContext(),message);
    }
